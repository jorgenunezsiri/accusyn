          ...
          <div className="col-lg-10">
            <div className="jumbotron">
              ...
              <p className="lead" align="justify">
                As even simple organisms have huge numbers of genetic features, syntenic graphs present an enormous clutter
              ...
              <p className="lead" align="justify">
                ...
                decluttering of the Wheat genome in the above image).{' '} <em>AccuSyn</em> also allow users to manually drag chromosomes around
              ...
              <ul className="lead" align="justify">
                ...
                In <em>AccuSyn</em>, users can either load a simplified four columns GFF file (chrID, featureID,
                  featureStart, featureEnd) or a complete nine columns GFF3 file.</li>
                ...
                <li><em>BedGraph</em> file: Uses four columns of data (chrID, chrStart, chrEnd, dataValue) to display additional genomic track data
                as heatmaps, histograms, lines, and scatterplots.</li>
              </ul>
